      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-tana-bg/80 backdrop-blur-md border-b border-tana-border' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/terms" className="text-sm font-medium text-tana-muted hover:text-white transition-colors">Terms</Link>
          ...
          <div className="space-y-12">
            ...
            <section className="rounded-2xl border border-tana-border bg-tana-card/30 backdrop-blur-sm p-8">
              ...
              <p className="text-tana-muted leading-relaxed mb-4">
                TanaChat.ai ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our service, including our web application, API services, and MCP (Model Context Protocol) server integrations.
              </p>
              <p className="text-tana-muted leading-relaxed">
                By using TanaChat.ai, you consent to the data practices described in this policy. If you do not agree with the terms of this privacy policy, please do not access or use our service.
              </p>
            </section>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="space-y-2 text-tana-muted list-disc list-inside">
                    ...
                    <li><strong>Chat Content:</strong> Messages, prompts, and conversations you have with AI models</li>
                    <li><strong>Tana Workspace Data:</strong> Node structures, field data, and connections you import from Tana</li>
                    <li><strong>CLI Usage Data:</strong> Commands executed and files processed through our CLI tools</li>
                    <li><strong>Communications:</strong> Support requests, feedback, and other communications with us</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-tana-muted list-disc list-inside">
                    ...
                    <li><strong>Log Data:</strong> IP addresses, browser types, device information, and timestamps</li>
                    <li><strong>Performance Data:</strong> Response times, error rates, and system performance metrics</li>
                    <li><strong>API Usage:</strong> Request counts, response sizes, and integration usage patterns</li>
                  </ul>
                </div>

                <div>
                  <h3 className="text-xl font-semibold mb-3 text-white">2.3 Cookies and Tracking Technologies</h3>
            ...
            <section className="rounded-2xl border border-tana-border bg-tana-card/30 backdrop-blur-sm p-8">
              ...
              <div className="space-y-4 text-tana-muted">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <strong>Service Provision:</strong> To provide, maintain, and improve our AI-powered chat services and Tana integration features
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full bg-indigo-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Personalization:</strong> To customize your experience and provide relevant AI responses based on your Tana workspace data
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full bg-indigo-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Communication:</strong> To respond to your inquiries, provide support, and send important service updates
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full bg-indigo-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Analytics:</strong> To analyze usage patterns, improve service performance, and develop new features
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full bg-indigo-500 mt-2 flex-shrink-0"></div>
            ...
            <section className="rounded-2xl border border-tana-border bg-tana-card/30 backdrop-blur-sm p-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold mb-3 text-white">4.1 Third-Party AI Providers</h3>
                  <p className="text-tana-muted leading-relaxed">
                    Your chat messages may be processed by third-party AI providers (Claude/Anthropic, OpenAI/ChatGPT) to generate responses. These providers have their own privacy policies and data handling practices.
                  </p>
                </div>
            ...
            <section className="rounded-2xl border border-tana-border bg-tana-card/30 backdrop-blur-sm p-8">
              ...
              <ul className="space-y-2 text-tana-muted list-disc list-inside">
                <li><strong>Chat History:</strong> Retained for 365 days from creation date, unless you delete it sooner</li>
                <li><strong>Account Information:</strong> Retained while your account is active</li>
                <li><strong>Usage Logs:</strong> Retained for 90 days for security and performance analysis</li>
            ...
            <section className="rounded-2xl border border-tana-border bg-tana-card/30 backdrop-blur-sm p-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold mb-3 text-white">7.1 Access and Correction</h3>
                  <p className="text-tana-muted leading-relaxed">
                ...
                <div>
                  ...
                  <p className="text-tana-muted leading-relaxed">
                    You can request deletion of your account and associated data at any time. We will delete your information within 30 days, except where we're required to retain it for legal or legitimate business purposes.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-tana-muted leading-relaxed">
                    You can request a copy of your data in a structured, machine-readable format. We provide export functionality for chat history and workspace data.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-tana-muted leading-relaxed">
                    You can opt out of non-essential data collection and processing through your account preferences or by adjusting browser settings.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-2xl border border-tana-border bg-tana-card/30 backdrop-blur-sm p-8">
              ...
              <p className="text-tana-muted leading-relaxed">
                Your information may be transferred to and processed in countries other than your own. When we transfer your information internationally, we ensure appropriate safeguards are in place to protect your privacy rights, including standard contractual clauses or other legally recognized mechanisms.
              </p>
            </section>
            ...
            <section className="rounded-2xl border border-tana-border bg-tana-card/30 backdrop-blur-sm p-8">
              ...
              <p className="text-tana-muted leading-relaxed">
                We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new policy on this page and updating the "Last updated" date. Continued use of our service after any changes constitutes acceptance of the updated policy.
              </p>
            </section>
            ...
            <section className="rounded-2xl border border-tana-border bg-tana-card/30 backdrop-blur-sm p-8">
              ...
              <div className="bg-tana-bg/50 rounded-lg p-4 space-y-2 text-tana-muted">
                <p><strong>Email:</strong> privacy@tanachat.ai</p>
