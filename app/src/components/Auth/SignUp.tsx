            ...
            <div className="w-full max-w-md relative z-10 animate-slide-up">
                ...
                <div className="bg-tana-card/50 backdrop-blur-xl border border-tana-border p-8 rounded-3xl shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <label className="block text-xs font-medium text-tana-muted uppercase mb-1 ml-1">Full Name</label>
                            <input
                                type="text"
                                value={name}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block text-xs font-medium text-tana-muted uppercase mb-1 ml-1">Confirm</label>
                                <input
                                    type="password"
