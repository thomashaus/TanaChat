      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        ...
        <div className="bg-tana-card/50 backdrop-blur-xl border border-tana-border p-8 rounded-3xl shadow-2xl">
          ...
          <div className="flex justify-center">
            <button className="flex items-center justify-center px-6 py-2 border border-tana-border rounded-xl hover:bg-white/5 transition-colors text-white text-sm font-medium">
