      ...
      <div className="w-full max-w-2xl">
        ...
        >
          <div className="pointer-events-none">
            ...
            <p className="text-xs text-gray-500 mt-4">Supports .json, .md, .txt (Max 50MB)</p>
          </div>
        </div>
        ...
        {files.length > 0 && (
          <div className="mt-8 space-y-3 animate-slide-up">
            {files.map((file, i) => (
              <div
                key={i}
                className="bg-tana-card border border-tana-border rounded-xl p-4 flex items-center justify-between group hover:border-indigo-500/30 transition-colors"
              >
