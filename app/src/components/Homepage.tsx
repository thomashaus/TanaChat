      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-tana-bg/80 backdrop-blur-md border-b border-tana-border' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="https://tana.ai" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-tana-muted hover:text-white transition-colors">Tana</a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-16 left-0 w-full bg-tana-bg/95 backdrop-blur-xl border-b border-tana-border p-6 flex flex-col space-y-4 animate-fade-in">
            <a href="https://tana.ai" className="text-lg font-medium text-white">Tana</a>
      ...
      <main className="relative z-10 pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            ...
            <a href="http://localhost:8000/docs" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-8 py-4 rounded-full border border-tana-border bg-tana-card/30 hover:bg-tana-card/50 text-white font-medium text-lg transition-all backdrop-blur-sm">
              API Documentation
            </a>
          </div>
        </div>
      ...
      <footer className="border-t border-tana-border py-12 px-6 bg-tana-bg relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex space-x-6 text-sm text-tana-muted">
            ...
            <a href="https://github.com/your-repo/tanachat" className="hover:text-white transition-colors">GitHub</a>
          </div>
        </div>
      </footer>
    </div>
