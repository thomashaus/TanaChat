...
export function Homepage() {
  ...
  return (
    <div className="min-h-screen bg-tana-bg text-tana-text selection:bg-indigo-500/30 overflow-x-hidden">
      ...
      {/* Help Link - Bottom Right */}
      <div className="fixed bottom-6 right-6 z-50">
        <a
          href="https://github.com/thomashaus/TanaChat/"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-full shadow-lg transition-all duration-200 flex items-center space-x-2 text-sm font-medium"
          title="Get Help"
        >
