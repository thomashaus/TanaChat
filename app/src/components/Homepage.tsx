    ...
    <div className="min-h-screen bg-tana-bg text-tana-text selection:bg-indigo-500/30 overflow-x-hidden">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-tana-bg/80 backdrop-blur-md border-b border-tana-border' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <span className="font-bold text-lg tracking-tight">TanaChat<span className="text-tana-muted">.ai</span></span>
          </div>

          <div className="hidden md:flex items-center space-x-8">
            <a href="https://tana.inc" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-tana-muted hover:text-white transition-colors">Tana</a>
            <a href="https://claude.ai" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-tana-muted hover:text-white transition-colors">Claude</a>
            <a href="https://chat.openai.com" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-tana-muted hover:text-white transition-colors">ChatGPT</a>
            <a href="/signin" className="px-4 py-2 rounded-full bg-white text-black text-sm font-semibold hover:bg-gray-200 transition-colors">
              Sign In
            </a>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-16 left-0 w-full bg-tana-bg/95 backdrop-blur-xl border-b border-tana-border p-6 flex flex-col space-y-4 animate-fade-in">
            <a href="https://tana.inc" className="text-lg font-medium text-white">Tana</a>
            <a href="https://claude.ai" className="text-lg font-medium text-white">Claude</a>
            <a href="https://chat.openai.com" className="text-lg font-medium text-white">ChatGPT</a>
            <a href="/signin" className="px-4 py-3 rounded-xl bg-white text-black text-center font-bold">
              Sign In
            </a>
          </div>
        )}
      ...
      <main className="relative z-10 pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-tana-muted max-w-2xl mx-auto mb-12 leading-relaxed animate-slide-up" style={{ animationDelay: '0.1s' }}>
            Transform your visual thinking into actionable workflows. Seamlessly connect Tana's knowledge graph with the power of Claude and ChatGPT.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <a href="/chat" className="w-full sm:w-auto px-8 py-4 rounded-full bg-white text-black font-bold text-lg hover:bg-gray-200 transition-all transform hover:scale-105 shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)]">
              Get Started
            </a>
            <a href={`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/docs`} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-8 py-4 rounded-full border border-tana-border bg-tana-card/30 hover:bg-tana-card/50 text-white font-medium text-lg transition-all backdrop-blur-sm">
              API Documentation
            </a>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto mt-32 grid grid-cols-1 md:grid-cols-3 gap-6 animate-slide-up" style={{ animationDelay: '0.4s' }}>
          {/* Main Feature */}
          <div className="md:col-span-2 row-span-2 rounded-3xl border border-tana-border bg-tana-card/30 backdrop-blur-sm p-8 relative overflow-hidden group hover:border-indigo-500/50 transition-colors">
            ...
            <p className="text-tana-muted mb-8 max-w-md">Your thoughts aren't linear, and neither should your AI be. TanaChat respects the structure of your Tana workspace while injecting AI capabilities exactly where you need them.</p>
          ...
          <div className="rounded-3xl border border-tana-border bg-tana-card/30 backdrop-blur-sm p-8 relative overflow-hidden group hover:border-orange-500/50 transition-colors">
            ...
            <p className="text-sm text-tana-muted">Deep integration with Claude Desktop for advanced reasoning and coding tasks.</p>
          </div>
          ...
          <div className="rounded-3xl border border-tana-border bg-tana-card/30 backdrop-blur-sm p-8 relative overflow-hidden group hover:border-green-500/50 transition-colors">
            ...
            <p className="text-sm text-tana-muted">Seamlessly pipe data to and from ChatGPT for creative writing and brainstorming.</p>
          </div>
        </div>
      </main>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              ...
              <p className="text-xl text-tana-muted mb-8 leading-relaxed">
                For power users, TanaChat offers a robust suite of CLI tools. Automate your workflow, batch process files, and integrate with your existing dev environment.
              </p>
              ...
              <a href="/hub" className="inline-flex items-center text-green-400 font-semibold hover:text-green-300 transition-colors">
              ...
              <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-gray-800 shadow-2xl font-mono text-sm">
                ...
                <div className="p-6 space-y-2">
                  <div className="flex">
                    ...
                    <span className="text-gray-300">./bin/tana-analyze --export workspace.json</span>
                  </div>
      ...
      <footer className="border-t border-tana-border py-12 px-6 bg-tana-bg relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex space-x-6 text-sm text-tana-muted">
            ...
            <a href="https://github.com/thomashaus/TanaChat" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">GitHub</a>
          </div>
        </div>
      </footer>
    </div>
