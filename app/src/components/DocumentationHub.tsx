...
export function DocumentationHub() {
    ...
    const sections = [
        ...
        { id: 'cli-tools', title: 'CLI Tools', icon: 'M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
        ...
        <div className="min-h-screen bg-tana-bg flex">
            ...
            <div className="w-64 border-r border-tana-border bg-tana-card/30 backdrop-blur-md fixed h-full z-20 hidden md:block">
                    ...
                    <nav className="space-y-2">
                        {sections.map((section) => (
                            <button
                                ...
                                className={`w-full flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 ${activeSection === section.id
                ...
                <div className="absolute bottom-0 w-full p-6 border-t border-tana-border">
                    <a href="/" className="flex items-center text-sm text-tana-muted hover:text-white transition-colors">
                ...
                <div className="max-w-4xl mx-auto animate-fade-in">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-tana-card border border-tana-border rounded-2xl p-6 hover:border-indigo-500/50 transition-colors group cursor-pointer">
                            ...
                            <p className="text-tana-muted mb-4">Deep dive into the core components: API, Validator, and MCP Server.</p>
                            <span className="text-indigo-400 text-sm font-medium group-hover:underline">Read more →</span>
                        </div>
                        ...
                        <div className="bg-tana-card border border-tana-border rounded-2xl p-6 hover:border-green-500/50 transition-colors group cursor-pointer">
                            ...
                            <p className="text-tana-muted mb-4">Master the command line tools for batch processing and automation.</p>
                            <span className="text-green-400 text-sm font-medium group-hover:underline">View commands →</span>
                        </div>
                        ...
                        <div className="bg-tana-card border border-tana-border rounded-2xl p-6 hover:border-purple-500/50 transition-colors group cursor-pointer">
                            ...
                            <p className="text-tana-muted mb-4">Get up and running with TanaChat in less than 5 minutes.</p>
                            <span className="text-purple-400 text-sm font-medium group-hover:underline">Start now →</span>
                        </div>
                    </div>
                </div>
            </div>
