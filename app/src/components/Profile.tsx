        ...
        <div className="min-h-screen bg-tana-bg text-tana-text">
            <div className="max-w-4xl mx-auto px-6 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    {/* Usage Stats */}
                    <div className="bg-tana-card border border-tana-border rounded-2xl p-8 animate-slide-up" style={{ animationDelay: '0.1s' }}>
...
function ConnectionItem({ name, description, connected, onToggle, icon, color }: ConnectionItemProps) {
    return (
        <div className="flex items-center justify-between">
            ...
            >
                <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${connected ? 'translate-x-6' : 'translate-x-1'}`} />
            </button>
        </div>
    );
}
